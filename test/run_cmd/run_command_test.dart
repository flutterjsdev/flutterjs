...
import 'validating/comprehensive_ir_validator.dart';

// ============================================================================
// UNIFIED COMMAND - Analysis → IR Generation Pipeline
// ============================================================================

class RunCommandTest extends Command<void> {
  RunCommandTest({required this.verbose, required this.verboseHelp}) {
    argParser
      ..addOption(
        'project',
        abbr: 'p',
  ...
  String _generateValidationJSON(ComprehensiveValidationReport report) {
    ...
    buffer.writeln('  "overall_status": "${report.fileReports.every((r) => r.isValid) ? 'PASS' : 'FAIL'}",');
