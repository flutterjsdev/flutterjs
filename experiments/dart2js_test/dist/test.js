...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 11:
              ...
              t8 = controller._async$_state;
              if ((t8 & 1) !== 0) {
                varData = controller._varData;
                t9 = (t2._as((t8 & 8) !== 0 ? t5._as(varData).get$_varData() : varData)._async$_state & 4) !== 0;
                t8 = t9;
              } else
                t8 = (t8 & 2) === 0;
              $async$goto = t8 ? 16 : 17;
            ...
            case 17:
              // join
              if ((controller._async$_state & 1) === 0) {
                // goto after for
                $async$goto = 7;
                break;
              }
    ...
    main() {
      var _null = null;
      A.get(A.Uri_parse("https://example.com"));
      A.printString($.$get$context().join$16(0, "foo", "bar", _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
    },
    toUint8List(input) {
      return input;
    },
  ...
  A._StreamController.prototype = {
    ...
    _subscribe$4(onData, onError, onDone, cancelOnError) {
      ...
      t2 = subscription._async$_state;
      subscription._async$_state = t2 | 64;
      t1.call$0();
      subscription._async$_state &= 4294967231;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.ListBase, A.Closure, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.SkipIterator, A.EmptyIterator, A.WhereTypeIterator, A.FixedLengthListMixin, A.UnmodifiableListMixin, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._AllMatchesIterator, A.StringMatch, A._StringAllMatchesIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamController, A._AsyncStreamControllerDispatch, A._BufferingStreamSubscription, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._DoneStreamSubscription, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.Codec, A.Converter, A.ByteConversionSink, A._Utf8Decoder, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.NullRejectionException, A.ClientException, A.BaseClient, A.BaseRequest, A.BaseResponse, A.Context, A.Style, A.ParsedPath]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._LinkedCustomHashMap_closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.get_closure, A.BaseRequest_closure0, A.BrowserClient_send_closure, A._bodyToStream_closure, A.ByteStream_toBytes_closure, A.Context_joinAll_closure, A._validateArgList_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainCoreFuture_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteErrorObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._BufferingStreamSubscription__sendError_sendError, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._MultiStream_listen_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A._Utf8Decoder__decoder_closure, A._Utf8Decoder__decoderNonfatal_closure, A._readStreamBody_closure, A._readStreamBody_closure0]);
    _inheritMany(A.Iterable, [A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.SkipIterable, A.WhereTypeIterable, A._KeysOrValues, A._AllMatchesIterable, A._StringAllMatchesIterable]);
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0, A.MapBase_mapToString_closure, A.Uri_parseIPv6Address_error, A.BaseRequest_closure]);
    ...
    _inheritMany(A.Stream, [A.StreamView, A._StreamImpl, A._EmptyStream, A._MultiStream]);
