...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'FlutterjsServices Example',
...
class _ExamplePageState extends State<ExamplePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('FlutterjsServices Example')),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Test FlutterjsServices'),
            ),
          ],
        ),
      ),
