...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'FlutterjsGestures Example',
...
class _ExamplePageState extends State<ExamplePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('FlutterjsGestures Example')),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Test FlutterjsGestures'),
            ),
          ],
        ),
      ),
