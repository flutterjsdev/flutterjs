...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'FlutterjsMaterial Example',
...
class _ExamplePageState extends State<ExamplePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('FlutterjsMaterial Example')),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Test FlutterjsMaterial'),
            ),
          ],
        ),
      ),
