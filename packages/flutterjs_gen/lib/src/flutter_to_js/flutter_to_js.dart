...
export 'src/widget_instantiation_code_gen.dart'
    hide WarningSeverity, CodeGenError, CodeGenWarning, Indenter;
...
export 'src/ir_post_deserialize_validator.dart'
    hide ValidationError, ValidationReport;
export 'src/stateless_widget_js_code_gen.dart'
    hide Indenter, CodeGenError, FirstWhereOrNull;
export 'src/stateful_widget_js_code_gen.dart'
    hide Indenter, CodeGenError, WarningSeverity, CodeGenWarning;
