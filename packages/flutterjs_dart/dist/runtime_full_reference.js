// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.11.0-113.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    LinkedHashSet_LinkedHashSet$_literal(values, $E) {
      return $E._eval$1("LinkedHashSet<0>")._as(A.fillLiteralSet(values, A._LinkedHashSet$($E)));
    },
    _LinkedHashSet$($E) {
    ...
    ListQueue$($E) {
      return new A.ListQueue(A.List_List$filled(A.ListQueue__calculateCapacity(null), null, $E._eval$1("0?")), $E._eval$1("ListQueue<0>"));
    },
    ListQueue__calculateCapacity(initialCapacity) {
      if (initialCapacity == null || initialCapacity < 8)
        return 8;
      else if (!A.ListQueue__isPowerOf2(initialCapacity))
    ...
    _ListQueueIterator$(queue, $E) {
      return new A._ListQueueIterator(queue, 0, 0, 0, $E._eval$1("_ListQueueIterator<0>"));
    },
    ...
    main() {
      var t2,
        t1 = type$.String;
      A.LinkedHashMap_LinkedHashMap$_literal(["key", "value"], t1, type$.dynamic);
      A.LinkedHashSet_LinkedHashSet$_literal(["a", "b"], t1);
      t2 = type$.int;
      A.Future_Future$value(42, t2);
      A.Stream_Stream$value(1, t2);
      A.Completer_Completer(t2);
      A.jsonDecode(A.jsonEncode(A.LinkedHashMap_LinkedHashMap$_literal(["test", true], t1, type$.bool)));
      A.ListQueue$(t2);
      A.HashMap_HashMap(t1, t2);
      A.NativeUint8List_NativeUint8List(10);
      A.NativeByteData_NativeByteData(8);
      A.Random_Random();
      A.print("Runtime extracted");
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A._StreamController.prototype = {
    get$stream() {
      return A._ControllerStream$(this, this.$ti._precomputed1);
    },
    get$hasListener() {
      return (this._state & 1) !== 0;
    },
    ...
    _ensurePendingEvents$0() {
      ...
      if (!_this.get$_isAddingStream()) {
        ...
        if (events == null)
          events = _this._varData = A._PendingEvents$(_this.$ti._precomputed1);
    ...
    _recordCancel$1(subscription) {
      ...
      _this._varData = null;
      _this._state = (_this._state & 4294967286 | 2) >>> 0;
  ...
  A._BufferingStreamSubscription.prototype = {
    ...
    _checkState$1(wasInputPaused) {
      ...
      if (_this.get$_hasPending() && _this._pending.get$isEmpty(0)) {
  ...
  A.ListQueue.prototype = {
    ...
    _checkModification$1(expectedModificationCount) {
      if (A._asInt(expectedModificationCount) !== 0)
  ...
  A._convertJsonToDart_walk.prototype = {
    call$1(e) {
      var t1, i, map, processed, keys, key, _this = this;
      ...
      for (t1 = _this.reviver, i = 0; i < keys.length; ++i) {
        key = keys[i];
        processed[key] = t1.call$2(key, _this.call$1(e[key]));
      }
  ...
  A._JsonMap.prototype = {
    ...
    _upgrade$0() {
      var result, keys, i, key, t1, _this = this;
      if (_this.get$_isUpgraded())
  ...
  A._JsonMapKeyIterable.prototype = {
    ...
    elementAt$1(_, index) {
      ...
      A._asInt(index);
      t1 = this._parent;
      if (t1.get$_isUpgraded())
        t1 = J.elementAt$1$ax(t1.get$keys(), index);
      else {
  ...
  A._JsonStringifier.prototype = {
    ...
    writeMap$1(map) {
      ...
      keyValueList = A.List_List$filled(map.get$length(map) * 2, null, type$.nullable_Object);
      i = _box_0.i = 0;
  ...
  A._JSRandom.prototype = {$isRandom: 1};
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 13, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.Closure, A.Iterable, A.ListIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamController, A._AsyncStreamControllerDispatch, A._BufferingStreamSubscription, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._ZoneFunction, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._ListQueueIterator, A.Codec, A.Converter, A._JsonStringifier, A._JsonPrettyPrintMixin, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A._JSRandom]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._convertJsonToDart_walk]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainCoreFuture_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteErrorObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._rootHandleError_closure, A._RootZone_bindCallback_closure, A._RootZone_bindCallbackGuarded_closure]);
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0, A.MapBase_mapToString_closure, A._JsonStringifier_writeMap_closure, A._JsonPrettyPrintMixin_writeMap_closure]);
...
;
  ...
  (function nativeSupport() {
    ...
    hunkHelpers.setOrUpdateInterceptorsByTag({ArrayBufferView: A.NativeTypedData, DataView: A.NativeByteData, Uint8Array: A.NativeUint8List});
    hunkHelpers.setOrUpdateLeafTags({ArrayBufferView: false, DataView: true, Uint8Array: false});
