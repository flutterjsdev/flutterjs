import{VNodeRenderer as h}from"./vnode_renderer.js";import{SSRRenderer as u}from"./ssr_renderer.js";class d{static render(t,e=null,s={}){return this.detectEnvironment()==="server"?this.renderServer(t,s):this.renderClient(t,e,s)}static detectEnvironment(){return typeof window<"u"&&typeof window.document<"u"?"client":typeof process<"u"&&process.versions&&process.versions.node?"server":"client"}static renderServer(t,e={}){const{title:s="FlutterJS App",includeHydration:r=!0,includeCriticalCSS:i=!0,includeRuntime:n=!0,meta:a={},scripts:c=[],styles:o=[]}=e,f=u.renderVNode(t),l=r?this.generateHydrationData(t):null,p=i?this.extractCriticalCSS(t):"";return this.buildHTMLDocument({title:s,meta:a,criticalCSS:p,bodyHTML:f,hydrationData:l,scripts:c,styles:o,includeRuntime:n})}static renderClient(t,e,s={}){if(!e)throw new Error("Target element is required for client-side rendering");const{clear:r=!0,measurePerformance:i=!1}=s,n=i?performance.now():0,a=h.render(t,e,{clear:r});if(i){const c=performance.now();console.log(`Render time: ${(c-n).toFixed(2)}ms`)}return a}static buildHTMLDocument({title:t,meta:e,criticalCSS:s,bodyHTML:r,hydrationData:i,scripts:n,styles:a,includeRuntime:c}){const o=this.generateMetaTags(e),f=this.generateStyleTags(a,s),l=this.generateScriptTags(n,c),p=i?`<script id="__FLUTTERJS_HYDRATION_DATA__" type="application/json">${JSON.stringify(i)}</script>`:"";return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
