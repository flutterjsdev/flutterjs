...
import { VNodeDiffer } from './packages/flutterjs_vdom/flutterjs_vdom/src/vnode_differ.js';
import { VNode } from './packages/flutterjs_vdom/flutterjs_vdom/src/vnode.js';

// Mock VNode structure if VNode import fails (since we are running in node without full build)
const MockVNode = (tag, children) => new VNode({
    tag,
    children,
    props: {},
    key: null
