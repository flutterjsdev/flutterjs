...
class BinaryConstants {
  ...
  static String getExpressionTypeName(int type) {
    switch (type) {
      ...
      case EXPR_METHOD_CALL: return 'MethodCall';
      case EXPR_PROPERTY_ACCESS: return 'PropertyAccess';
      case EXPR_CONDITIONAL: return 'Conditional';
      case EXPR_LIST_LITERAL: return 'ListLiteral';
      case EXPR_MAP_LITERAL: return 'MapLiteral';
      case EXPR_ASSIGNMENT: return 'Assignment';
      case EXPR_CAST: return 'Cast';
      case EXPR_TYPE_CHECK: return 'TypeCheck';
      case EXPR_LAMBDA: return 'Lambda';
      case EXPR_AWAIT: return 'Await';
      case EXPR_THROW: return 'Throw';
      case EXPR_INDEX_ACCESS: return 'IndexAccess';
  ...
  static String getStatementTypeName(int type) {
    switch (type) {
      ...
      case STMT_VAR_DECL: return 'VarDecl';
      case STMT_IF: return 'If';
      case STMT_FOR: return 'For';
      case STMT_FOR_EACH: return 'ForEach';
      case STMT_WHILE: return 'While';
      case STMT_DO_WHILE: return 'DoWhile';
