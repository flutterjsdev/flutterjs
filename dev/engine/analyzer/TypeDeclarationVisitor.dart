...
class TypeDeclarationVisitor extends RecursiveAstVisitor<void> {
  ...
  void visitClassDeclaration(ClassDeclaration node) {
    ...
    if (fragment != null) {
      final element =
          fragment.element; // Get the ClassElement from the fragment

      final typeInfo = TypeInfo(
        name: element.name ?? "<anonymous>",
        fullyQualifiedName: element.displayName.isEmpty
            ? "<anonymous>"
            : element.displayName,
  ...
  void visitMixinDeclaration(MixinDeclaration node) {
    ...
    if (fragment != null) {
      final element =
          fragment.element; // Get the MixinElement from the fragment
  ...
  void visitGenericTypeAlias(GenericTypeAlias node) {
    ...
    if (fragment != null) {
      final element =
          fragment.element as TypeAliasElement; // Cast to TypeAliasElement
  ...
  bool _extendsOrImplements(ClassElement element, String typeName) {
    ...
    while (current != null) {
      ...
      current =
          current.element.supertype; // Access supertype through the element
    }
